...
from mmdet.models.utils.transformer import Transformer, DeformableDetrTransformer
    ...
    def _init_layers(self):
        ...
        if self.with_pos_coord:
            if self.with_coord_feat:
                self.pos_feats_trans = nn.Linear(self.embed_dims, self.embed_dims)
                self.pos_feats_norm = nn.LayerNorm(self.embed_dims)
